...
6. When the app is served from GitHub Pages, the browser falls back to `public-demo-data/patients-bundle.json` because GitHub Pages cannot host server handler execution.
